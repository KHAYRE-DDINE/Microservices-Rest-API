...
public class CampaignController {
    ...
    public ResponseEntity<List<CampaignResponseDTO>> getByAffiliateId(@PathVariable Long affiliateId){
        return ResponseEntity.ok(campaignService.getCampaignByAffiliateId(affiliateId));
    }
}